...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CSSX = __webpack_require__(159);
	
	var _CSSX2 = _interopRequireDefault(_CSSX);
	...
	_reactDom2.default.render(_react2.default.createElement(Component, null), document.querySelector('#content'));
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (/******/function (modules) {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				(function webpackUniversalModuleDefinition(root, factory) {
					if (true) module.exports = factory();else if (typeof define === 'function' && define.amd) define("cssx", [], factory);else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["cssx"] = factory();else root["cssx"] = factory();
				})(this, function () {
					return (/******/function (modules) {
							// webpackBootstrap
							/******/ // The module cache
						...
						/***/function (module, exports, __webpack_require__) {
							...
							module.exports = function (id) {
								...
								var ruleExists = function ruleExists(selector, parent) {
								...
								var getOnlyTopRules = function getOnlyTopRules() {
						...
						/***/function (module, exports, __webpack_require__) {
							...
							_CSSRule = function CSSRule(selector, props, stylesheet) {
								var _id = getId();
								var _children = [];
								var _nestedChildren = [];
								...
								var record = {
									...
									parent: null,
									addChild: function addChild(c, isWrapper) {
									...
									setChildren: function setChildren(c) {
										_children = c;
									},
									getNestedChildren: function getNestedChildren() {
										return _nestedChildren;
									},
									setNestedChildren: function setNestedChildren(c) {
										_nestedChildren = c;
									},
									descendant: function descendant(s, p) {
										if (isArray(s)) {
									...
									clone: function clone() {
										var rule = _CSSRule(this.selector, this.props, stylesheet);
						...
						/***/function (module, exports, __webpack_require__) {
							...
							var prefixProperty = function prefixProperty(list) {
							...
							module.exports = {
								selector: function selector(rules) {
									var result = [],
									    keyword,
									    newRule,
									    sel;
								...
								property: function property(props) {
